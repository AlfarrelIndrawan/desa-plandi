...
<div class="container-fluid">
    <div class="card border-left-success shadow mb-4">
        <div class="card-header py-3">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="m-0 font-weight-bold text-success">TAMBAH PENDUDUK</h3>
                </div>
            </div>
        </div>
        <div class="card-body">
            <div class="container-fluid">
                <form action="<?= base_url('Admin/tambahPenduduk') ?>" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="nik">NIK</label>
                        <input value="<?= old('nik') ?>" type="text" class="form-control <?= ($validation->hasError('nik')) ? 'is-invalid' : ''; ?>" id="nik" name="nik">
                    ...
                    <div class="form-group">
                        ...
                        <input value="<?= old('nama') ?>" type="text" class="form-control <?= ($validation->hasError('nama')) ? 'is-invalid' : ''; ?>" id="nama" name="nama">
                        <div id="validationServer03Feedback" class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <input value="<?= old('tgl_lahir') ?>" type="date" class="form-control <?= ($validation->hasError('tgl_lahir')) ? 'is-invalid' : ''; ?>" id="tgl_lahir" name="tgl_lahir">
                        <div id="validationServer03Feedback" class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <?php if (old('pendidikan') == 'Tidak/Belum Sekolah') { ?>
                            ...
                            <?php } elseif(old('pendidikan') == 'Belum Tamat SD/Sederajat') { ?>
                                ...
                                <option value="Diploma IV/Strata I">Diploma IV/Strata I</option>
                                <option value="Strata II">Strata II</option>
                            <?php } elseif(old('pendidikan') == 'Tamat SD/Sederajat') { ?>
                                <option value="Tidak/Belum Sekolah">Tidak/Belum Sekolah</option>
                                <option value="Belum Tamat SD/Sederajat">Belum Tamat SD/Sederajat</option>
                                ...
                                <option value="Diploma IV/Strata I">Diploma IV/Strata I</option>
                                <option value="Strata II">Strata II</option>
                            <?php } elseif(old('pendidikan') == 'SLTP/Sederajat') { ?>
                                <option value="Tidak/Belum Sekolah">Tidak/Belum Sekolah</option>
                                <option value="Belum Tamat SD/Sederajat">Belum Tamat SD/Sederajat</option>
                                <option value="Tamat SD/Sederajat">Tamat SD/Sederajat</option>
                                ...
                                <option value="Diploma IV/Strata I">Diploma IV/Strata I</option>
                                <option value="Strata II">Strata II</option>
                            <?php } elseif(old('pendidikan') == 'SLTA/Sederajat') { ?>
                                <option value="Tidak/Belum Sekolah">Tidak/Belum Sekolah</option>
                                <option value="Belum Tamat SD/Sederajat">Belum Tamat SD/Sederajat</option>
                                <option value="Tamat SD/Sederajat">Tamat SD/Sederajat</option>
                                <option value="SLTP/Sederajat">SLTP/Sederajat</option>
                                ...
                                <option value="Diploma IV/Strata I">Diploma IV/Strata I</option>
                                <option value="Strata II">Strata II</option>
                            <?php } elseif(old('pendidikan') == 'Diploma I/II') { ?>
                                <option value="Tidak/Belum Sekolah">Tidak/Belum Sekolah</option>
                                <option value="Belum Tamat SD/Sederajat">Belum Tamat SD/Sederajat</option>
                                <option value="Tamat SD/Sederajat">Tamat SD/Sederajat</option>
                                <option value="SLTP/Sederajat">SLTP/Sederajat</option>
                                ...
                                <option value="Diploma IV/Strata I">Diploma IV/Strata I</option>
                                <option value="Strata II">Strata II</option>
                            <?php } elseif(old('pendidikan') == 'Akademi/Diploma III/S.Muda') { ?>
                                <option value="Tidak/Belum Sekolah">Tidak/Belum Sekolah</option>
                                <option value="Belum Tamat SD/Sederajat">Belum Tamat SD/Sederajat</option>
                                <option value="Tamat SD/Sederajat">Tamat SD/Sederajat</option>
                                <option value="SLTP/Sederajat">SLTP/Sederajat</option>
                                ...
                                <option value="Diploma IV/Strata I">Diploma IV/Strata I</option>
                                <option value="Strata II">Strata II</option>
                            <?php } elseif(old('pendidikan') == 'Diploma IV/Strata I') { ?>
                                <option value="Tidak/Belum Sekolah">Tidak/Belum Sekolah</option>
                                <option value="Belum Tamat SD/Sederajat">Belum Tamat SD/Sederajat</option>
                                <option value="Tamat SD/Sederajat">Tamat SD/Sederajat</option>
                                <option value="SLTP/Sederajat">SLTP/Sederajat</option>
                    ...
                    <div class="form-group">
                        ...
                        <?php if (old('pekerjaan') == 'BELUM/TIDAK BEKERJA') { ?>
                            ...
                            <?php } elseif(old('pekerjaan') == 'BIDAN') { ?>
                                ...
                                <option value="WIRASWASTA">WIRASWASTA</option>
                                <option value="LAINNYA">LAINNYA</option>
                            <?php } elseif(old('pekerjaan') == 'BURUH HARIAN LEPAS') { ?>
                                <option value="BELUM/TIDAK BEKERJA">BELUM/TIDAK BEKERJA</option>
                                <option value="BIDAN">BIDAN</option>
                                ...
                                <option value="WIRASWASTA">WIRASWASTA</option>
                                <option value="LAINNYA">LAINNYA</option>
                            <?php } elseif(old('pekerjaan') == 'BURUH PETERNAKAN') { ?>
                                <option value="BELUM/TIDAK BEKERJA">BELUM/TIDAK BEKERJA</option>
                                <option value="BIDAN">BIDAN</option>
                                <option value="BURUH HARIAN LEPAS">BURUH HARIAN LEPAS</option>
                                ...
                                <option value="WIRASWASTA">WIRASWASTA</option>
                                <option value="LAINNYA">LAINNYA</option>
                            <?php } elseif(old('pekerjaan') == 'BURUH TANI/PERKEBUNAN') { ?>
                                <option value="BELUM/TIDAK BEKERJA">BELUM/TIDAK BEKERJA</option>
                                <option value="BIDAN">BIDAN</option>
                                <option value="BURUH HARIAN LEPAS">BURUH HARIAN LEPAS</option>
                                <option value="BURUH PETERNAKAN">BURUH PETERNAKAN</option>
                                ...
                                <option value="WIRASWASTA">WIRASWASTA</option>
                                <option value="LAINNYA">LAINNYA</option>
                            <?php } elseif(old('pekerjaan') == 'DOKTER') { ?>
                                <option value="BELUM/TIDAK BEKERJA">BELUM/TIDAK BEKERJA</option>
                                <option value="BIDAN">BIDAN</option>
                                <option value="BURUH HARIAN LEPAS">BURUH HARIAN LEPAS</option>
                                <option value="BURUH PETERNAKAN">BURUH PETERNAKAN</option>
                            ...
                            <?php } elseif(old('pekerjaan') == 'GURU') { ?>
                                ...
                                <option value="WIRASWASTA">WIRASWASTA</option>
                                <option value="LAINNYA">LAINNYA</option>
                            <?php } elseif(old('pekerjaan') == 'INDUSTRI') { ?>
                                <option value="BELUM/TIDAK BEKERJA">BELUM/TIDAK BEKERJA</option>
                                <option value="BIDAN">BIDAN</option>
                                <option value="BURUH HARIAN LEPAS">BURUH HARIAN LEPAS</option>
                                <option value="BURUH PETERNAKAN">BURUH PETERNAKAN</option>
                                ...
                                <option value="WIRASWASTA">WIRASWASTA</option>
                                <option value="LAINNYA">LAINNYA</option>
                            <?php } elseif(old('pekerjaan') == 'KARYAWAN HONORER') { ?>
                                <option value="BELUM/TIDAK BEKERJA">BELUM/TIDAK BEKERJA</option>
                                <option value="BIDAN">BIDAN</option>
                                <option value="BURUH HARIAN LEPAS">BURUH HARIAN LEPAS</option>
                                <option value="BURUH PETERNAKAN">BURUH PETERNAKAN</option>
                                ...
                                <option value="WIRASWASTA">WIRASWASTA</option>
                                <option value="LAINNYA">LAINNYA</option>
                            <?php } elseif(old('pekerjaan') == 'KARYAWAN SWASTA') { ?>
                                <option value="BELUM/TIDAK BEKERJA">BELUM/TIDAK BEKERJA</option>
                                <option value="BIDAN">BIDAN</option>
                                <option value="BURUH HARIAN LEPAS">BURUH HARIAN LEPAS</option>
                                <option value="BURUH PETERNAKAN">BURUH PETERNAKAN</option>
                                ...
                                <option value="WIRASWASTA">WIRASWASTA</option>
                                <option value="LAINNYA">LAINNYA</option>
                            <?php } elseif(old('pekerjaan') == 'KEPALA DESA') { ?>
                                <option value="BELUM/TIDAK BEKERJA">BELUM/TIDAK BEKERJA</option>
                                <option value="BIDAN">BIDAN</option>
                                <option value="BURUH HARIAN LEPAS">BURUH HARIAN LEPAS</option>
                                <option value="BURUH PETERNAKAN">BURUH PETERNAKAN</option>
                                ...
                                <option value="WIRASWASTA">WIRASWASTA</option>
                                <option value="LAINNYA">LAINNYA</option>
                            <?php } elseif(old('pekerjaan') == 'KEPOLISIAN RI') { ?>
                                <option value="BELUM/TIDAK BEKERJA">BELUM/TIDAK BEKERJA</option>
                                <option value="BIDAN">BIDAN</option>
                                <option value="BURUH HARIAN LEPAS">BURUH HARIAN LEPAS</option>
                                <option value="BURUH PETERNAKAN">BURUH PETERNAKAN</option>
                                ...
                                <option value="WIRASWASTA">WIRASWASTA</option>
                                <option value="LAINNYA">LAINNYA</option>
                            <?php } elseif(old('pekerjaan') == 'KONSTRUKSI') { ?>
                                <option value="BELUM/TIDAK BEKERJA">BELUM/TIDAK BEKERJA</option>
                                <option value="BIDAN">BIDAN</option>
                                <option value="BURUH HARIAN LEPAS">BURUH HARIAN LEPAS</option>
                                <option value="BURUH PETERNAKAN">BURUH PETERNAKAN</option>
                                ...
                                <option value="WIRASWASTA">WIRASWASTA</option>
                                <option value="LAINNYA">LAINNYA</option>
                            <?php } elseif(old('pekerjaan') == 'MENGURUS RUMAH TANGGA') { ?>
                                <option value="BELUM/TIDAK BEKERJA">BELUM/TIDAK BEKERJA</option>
                                <option value="BIDAN">BIDAN</option>
                                <option value="BURUH HARIAN LEPAS">BURUH HARIAN LEPAS</option>
                                <option value="BURUH PETERNAKAN">BURUH PETERNAKAN</option>
                                ...
                                <option value="WIRASWASTA">WIRASWASTA</option>
                                <option value="LAINNYA">LAINNYA</option>
                            <?php } elseif(old('pekerjaan') == 'PENSIUNAN') { ?>
                                <option value="BELUM/TIDAK BEKERJA">BELUM/TIDAK BEKERJA</option>
                                <option value="BIDAN">BIDAN</option>
                                <option value="BURUH HARIAN LEPAS">BURUH HARIAN LEPAS</option>
                                <option value="BURUH PETERNAKAN">BURUH PETERNAKAN</option>
                                ...
                                <option value="WIRASWASTA">WIRASWASTA</option>
                                <option value="LAINNYA">LAINNYA</option>
                            <?php } elseif(old('pekerjaan') == 'PERANGKAT DESA') { ?>
                                <option value="BELUM/TIDAK BEKERJA">BELUM/TIDAK BEKERJA</option>
                                <option value="BIDAN">BIDAN</option>
                                <option value="BURUH HARIAN LEPAS">BURUH HARIAN LEPAS</option>
                                <option value="BURUH PETERNAKAN">BURUH PETERNAKAN</option>
                                ...
                                <option value="WIRASWASTA">WIRASWASTA</option>
                                <option value="LAINNYA">LAINNYA</option>
                            <?php } elseif(old('pekerjaan') == 'PERAWAT') { ?>
                                <option value="BELUM/TIDAK BEKERJA">BELUM/TIDAK BEKERJA</option>
                                <option value="BIDAN">BIDAN</option>
                                <option value="BURUH HARIAN LEPAS">BURUH HARIAN LEPAS</option>
                                <option value="BURUH PETERNAKAN">BURUH PETERNAKAN</option>
                                ...
                                <option value="WIRASWASTA">WIRASWASTA</option>
                                <option value="LAINNYA">LAINNYA</option>
                            <?php } elseif(old('pekerjaan') == 'PERDAGANGAN') { ?>
                                <option value="BELUM/TIDAK BEKERJA">BELUM/TIDAK BEKERJA</option>
                                <option value="BIDAN">BIDAN</option>
                                <option value="BURUH HARIAN LEPAS">BURUH HARIAN LEPAS</option>
                                <option value="BURUH PETERNAKAN">BURUH PETERNAKAN</option>
                                ...
                                <option value="WIRASWASTA">WIRASWASTA</option>
                                <option value="LAINNYA">LAINNYA</option>
                            <?php } elseif(old('pekerjaan') == 'PETANI/PEKEBUN') { ?>
                                <option value="BELUM/TIDAK BEKERJA">BELUM/TIDAK BEKERJA</option>
                                <option value="BIDAN">BIDAN</option>
                                <option value="BURUH HARIAN LEPAS">BURUH HARIAN LEPAS</option>
                                <option value="BURUH PETERNAKAN">BURUH PETERNAKAN</option>
                                ...
                                <option value="WIRASWASTA">WIRASWASTA</option>
                                <option value="LAINNYA">LAINNYA</option>
                            <?php } elseif(old('pekerjaan') == 'PETERNAK') { ?>
                                <option value="BELUM/TIDAK BEKERJA">BELUM/TIDAK BEKERJA</option>
                                <option value="BIDAN">BIDAN</option>
                                <option value="BURUH HARIAN LEPAS">BURUH HARIAN LEPAS</option>
                                <option value="BURUH PETERNAKAN">BURUH PETERNAKAN</option>
                                ...
                                <option value="WIRASWASTA">WIRASWASTA</option>
                                <option value="LAINNYA">LAINNYA</option>
                            <?php } elseif(old('pekerjaan') == 'SENIMAN') { ?>
                                <option value="BELUM/TIDAK BEKERJA">BELUM/TIDAK BEKERJA</option>
                                <option value="BIDAN">BIDAN</option>
                                <option value="BURUH HARIAN LEPAS">BURUH HARIAN LEPAS</option>
                                <option value="BURUH PETERNAKAN">BURUH PETERNAKAN</option>
                                ...
                                <option value="WIRASWASTA">WIRASWASTA</option>
                                <option value="LAINNYA">LAINNYA</option>
                            <?php } elseif(old('pekerjaan') == 'SOPIR') { ?>
                                <option value="BELUM/TIDAK BEKERJA">BELUM/TIDAK BEKERJA</option>
                                <option value="BIDAN">BIDAN</option>
                                <option value="BURUH HARIAN LEPAS">BURUH HARIAN LEPAS</option>
                                <option value="BURUH PETERNAKAN">BURUH PETERNAKAN</option>
                                ...
                                <option value="WIRASWASTA">WIRASWASTA</option>
                                <option value="LAINNYA">LAINNYA</option>
                            <?php } elseif(old('pekerjaan') == 'TENTARA NASIONAL INDONESIA') { ?>
                                <option value="BELUM/TIDAK BEKERJA">BELUM/TIDAK BEKERJA</option>
                                <option value="BIDAN">BIDAN</option>
                                <option value="BURUH HARIAN LEPAS">BURUH HARIAN LEPAS</option>
                                <option value="BURUH PETERNAKAN">BURUH PETERNAKAN</option>
                                ...
                                <option value="WIRASWASTA">WIRASWASTA</option>
                                <option value="LAINNYA">LAINNYA</option>
                            <?php } elseif(old('pekerjaan') == 'TRANSPORTASI') { ?>
                                <option value="BELUM/TIDAK BEKERJA">BELUM/TIDAK BEKERJA</option>
                                <option value="BIDAN">BIDAN</option>
                                <option value="BURUH HARIAN LEPAS">BURUH HARIAN LEPAS</option>
                                <option value="BURUH PETERNAKAN">BURUH PETERNAKAN</option>
                                ...
                                <option value="WIRASWASTA">WIRASWASTA</option>
                                <option value="LAINNYA">LAINNYA</option>
                            <?php } elseif(old('pekerjaan') == 'TUKANG BATU') { ?>
                                <option value="BELUM/TIDAK BEKERJA">BELUM/TIDAK BEKERJA</option>
                                <option value="BIDAN">BIDAN</option>
                                <option value="BURUH HARIAN LEPAS">BURUH HARIAN LEPAS</option>
                                <option value="BURUH PETERNAKAN">BURUH PETERNAKAN</option>
                                ...
                                <option value="WIRASWASTA">WIRASWASTA</option>
                                <option value="LAINNYA">LAINNYA</option>
                            <?php } elseif(old('pekerjaan') == 'TUKANG GIGI') { ?>
                                <option value="BELUM/TIDAK BEKERJA">BELUM/TIDAK BEKERJA</option>
                                <option value="BIDAN">BIDAN</option>
                                <option value="BURUH HARIAN LEPAS">BURUH HARIAN LEPAS</option>
                                <option value="BURUH PETERNAKAN">BURUH PETERNAKAN</option>
                                ...
                                <option value="WIRASWASTA">WIRASWASTA</option>
                                <option value="LAINNYA">LAINNYA</option>
                            <?php } elseif(old('pekerjaan') == 'TUKANG JAHIT') { ?>
                                <option value="BELUM/TIDAK BEKERJA">BELUM/TIDAK BEKERJA</option>
                                <option value="BIDAN">BIDAN</option>
                                <option value="BURUH HARIAN LEPAS">BURUH HARIAN LEPAS</option>
                                <option value="BURUH PETERNAKAN">BURUH PETERNAKAN</option>
                                ...
                                <option value="WIRASWASTA">WIRASWASTA</option>
                                <option value="LAINNYA">LAINNYA</option>
                            <?php } elseif(old('pekerjaan') == 'TUKANG KAYU') { ?>
                                <option value="BELUM/TIDAK BEKERJA">BELUM/TIDAK BEKERJA</option>
                                <option value="BIDAN">BIDAN</option>
                                <option value="BURUH HARIAN LEPAS">BURUH HARIAN LEPAS</option>
                                <option value="BURUH PETERNAKAN">BURUH PETERNAKAN</option>
                                ...
                                <option value="WIRASWASTA">WIRASWASTA</option>
                                <option value="LAINNYA">LAINNYA</option>
                            <?php } elseif(old('pekerjaan') == 'TUKANG LAS/PANDAI BESI') { ?>
                                <option value="BELUM/TIDAK BEKERJA">BELUM/TIDAK BEKERJA</option>
                                <option value="BIDAN">BIDAN</option>
                                <option value="BURUH HARIAN LEPAS">BURUH HARIAN LEPAS</option>
                                <option value="BURUH PETERNAKAN">BURUH PETERNAKAN</option>
                                ...
                                <option value="WIRASWASTA">WIRASWASTA</option>
                                <option value="LAINNYA">LAINNYA</option>
                            <?php } elseif(old('pekerjaan') == 'TUKANG LISTRIK') { ?>
                                <option value="BELUM/TIDAK BEKERJA">BELUM/TIDAK BEKERJA</option>
                                <option value="BIDAN">BIDAN</option>
                                <option value="BURUH HARIAN LEPAS">BURUH HARIAN LEPAS</option>
                                <option value="BURUH PETERNAKAN">BURUH PETERNAKAN</option>
                                ...
                                <option value="WIRASWASTA">WIRASWASTA</option>
                                <option value="LAINNYA">LAINNYA</option>
                            <?php } elseif(old('pekerjaan') == 'TUKANG SOL SEPATU') { ?>
                                <option value="BELUM/TIDAK BEKERJA">BELUM/TIDAK BEKERJA</option>
                                <option value="BIDAN">BIDAN</option>
                                <option value="BURUH HARIAN LEPAS">BURUH HARIAN LEPAS</option>
                                <option value="BURUH PETERNAKAN">BURUH PETERNAKAN</option>
                                ...
                                <option value="WIRASWASTA">WIRASWASTA</option>
                                <option value="LAINNYA">LAINNYA</option>
                            <?php } elseif(old('pekerjaan') == 'USTADZ/MUBALIGH') { ?>
                                <option value="BELUM/TIDAK BEKERJA">BELUM/TIDAK BEKERJA</option>
                                <option value="BIDAN">BIDAN</option>
                                <option value="BURUH HARIAN LEPAS">BURUH HARIAN LEPAS</option>
                                <option value="BURUH PETERNAKAN">BURUH PETERNAKAN</option>
                                ...
                                <option value="WIRASWASTA">WIRASWASTA</option>
                                <option value="LAINNYA">LAINNYA</option>
                            <?php } elseif(old('pekerjaan') == 'WIRASWASTA') { ?>
                                <option value="BELUM/TIDAK BEKERJA">BELUM/TIDAK BEKERJA</option>
                                <option value="BIDAN">BIDAN</option>
                                <option value="BURUH HARIAN LEPAS">BURUH HARIAN LEPAS</option>
                                <option value="BURUH PETERNAKAN">BURUH PETERNAKAN</option>
